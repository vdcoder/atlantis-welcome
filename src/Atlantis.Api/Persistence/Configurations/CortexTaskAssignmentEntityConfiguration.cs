...
public sealed class CortexTaskAssignmentEntityConfiguration
    : IEntityTypeConfiguration<CortexTaskAssignmentEntity>
{
    public void Configure(
        EntityTypeBuilder<CortexTaskAssignmentEntity> builder)
    {
        builder.ToTable(
        ...
        builder.HasOne(entity => entity.CortexTask)
            ...
            .HasForeignKey<CortexTaskAssignmentEntity>(
