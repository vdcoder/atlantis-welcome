...
public sealed class CortexJobApplicationEntityConfiguration
    : IEntityTypeConfiguration<CortexJobApplicationEntity>
{
    public void Configure(
        EntityTypeBuilder<CortexJobApplicationEntity> builder)
    {
