...
public sealed class CitizenSponsorshipEntityConfiguration
    : IEntityTypeConfiguration<CitizenSponsorshipEntity>
{
    public void Configure(
        EntityTypeBuilder<CitizenSponsorshipEntity> builder)
    {
        builder.ToTable(
