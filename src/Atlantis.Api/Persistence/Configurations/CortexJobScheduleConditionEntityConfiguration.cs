...
public sealed class CortexJobScheduleConditionEntityConfiguration
    : IEntityTypeConfiguration<CortexJobScheduleConditionEntity>
{
    public void Configure(
        EntityTypeBuilder<CortexJobScheduleConditionEntity> builder)
    {
        builder.ToTable(
