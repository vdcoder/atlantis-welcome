...
public sealed class CortexJobDefinitionRecordConfiguration
    : IEntityTypeConfiguration<CortexJobDefinitionRecord>
{
    public void Configure(
        EntityTypeBuilder<CortexJobDefinitionRecord> builder)
    {
