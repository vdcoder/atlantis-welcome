...
public sealed class
    WorkerCortexJobQualificationRecordConfiguration
    : IEntityTypeConfiguration<
        WorkerCortexJobQualificationRecord>
{
    public void Configure(
        EntityTypeBuilder<
            WorkerCortexJobQualificationRecord> builder)
    {
        builder.ToTable(
        ...
        builder.HasOne(entity =>
            ...
            .HasForeignKey<WorkerCortexJobQualificationRecord>(
                entity =>
                    entity.CortexJobApplicationId)
            .OnDelete(DeleteBehavior.Restrict);
