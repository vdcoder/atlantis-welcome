...
public sealed class CortexJobInboxMessageEntityConfiguration
    : IEntityTypeConfiguration<CortexJobInboxMessageEntity>
{
    public void Configure(
        EntityTypeBuilder<CortexJobInboxMessageEntity> builder)
    {
        builder.ToTable(
