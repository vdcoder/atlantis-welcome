...
public static class EconomySeed
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var issuerEntry = new LedgerEntryRecord
        {
            Id = Guid.NewGuid(),
        ...
        var developmentFundEntry = new LedgerEntryRecord
        {
            Id = Guid.NewGuid(),
            TransactionId = transactionId,
            AccountId =
    ...
    private static void ValidateBalancedTransaction(
        params LedgerEntryRecord[] entries)
    {
